...
public class WhatsAppProperties {
    ...
    private String botWelcomeReply = "👋 ¡Bienvenido a CEA HARO! Soy tu asistente virtual. Responde 9 para ver opciones.";
    private String botFallbackReply = "🤖 Gracias por escribir a CEA HARO. Responde 9 para ver opciones.";
